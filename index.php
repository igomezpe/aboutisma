    ...
    <div class="container">
        <div class="navbar">
            <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                  <a class="nav-link" id="pills-interests-tab" data-toggle="pill" href="#pills-interests" role="tab" aria-controls="pills-interests" aria-selected="false">Interests</a>
                </li>
                <li class="nav-item" role="presentation">
          ...
          <div class="tab-content" id="pills-tabContent">
            <div class="tab-pane fade show active" id="pills-about" role="tabpanel" aria-labelledby="pills-about-tab">
                ...
                <div class="jumbotron">
                    ...
                    <div class="col-md-4">
                        <img class="profile rounded-circle" src="static/profile.jpg" alt="">
                    </div>
                    <div class="col-md-8">
                        <h1 class="display-4" id="lblName">Ismael Avidan Gomez Perez</h1>
                        <p class="lead" id="lblDescription">This is a simple hero unit, a simple jumbotron-style component for calling extra attention to featured content or information.</p>
                        <hr class="my-4">
                        <p id="lblAdress">It uses utility classes for typography and spacing to space content out within the larger container.</p>
                        <ul class="list-group list-group-horizontal">
                            <li class="list-group-item" id="lblDNI">DNI | 71995715</li>
                            <li class="list-group-item" id="lblEmail">isgp@outlook.com.pe</li>
                            <li class="list-group-item" id="lblPhone">965 498 295</li>
                          </ul>
